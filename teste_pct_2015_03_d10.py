...
lista_classificada=lista_classificada[0:1]
lista_buffers=lista_buffers[0:4]
escala_edge=[7,19]
    ...
    for a in lista_buffers[0:4]:
        ...
        for b in y:
            ...
            for t in escala_edge:
              txtnameedge=names_txt+'_TXTEDGE_Pai_'+name+'_esc_'+`t`+".csv"
              ...
              createtxtED('bintem_dila_edge_int',txtnameedge,folderEd)
            grass.run_command('r.mask',flags='r')
            grass.run_command('g.remove',rast='apoio_mask,'+names_txt+'_Pai_'+name+"_FLT,bintemp_dila,bintem_dila_edge,bintem_dila_edge_int,apoio2") 
